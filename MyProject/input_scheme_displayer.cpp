...
InputSchemeDisplayer::InputSchemeDisplayer(
    ...
    : dxlib_input_ptr_(dxlib_input_ptr),
      keyboard_image_handle_(dxlib_resource_loader_ptr->getImageHandle(
          "data/img/icon_keyboard.png")),
      mouse_image_handle_(dxlib_resource_loader_ptr->getImageHandle(
          "data/img/icon_mouse.png")) {
  // nullptr チェック
...
void InputSchemeDisplayer::draw() const {
  ...
  } else if (dxlib_input_ptr_->getInputType() ==
             DxLibInput::InputType::kMouse) {
