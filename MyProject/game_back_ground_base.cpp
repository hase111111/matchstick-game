...
void GameBackGroundBase::draw() const {
  ...
  DrawBox(GameConst::kResolutionX * 9 / 32, 0, 0, GameConst::kResolutionY,
          color, TRUE);
  DrawBox(GameConst::kResolutionX * 23 / 32, 0, GameConst::kResolutionX,
          GameConst::kResolutionY, color, TRUE);
}
