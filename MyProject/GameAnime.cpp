...
//	const int TOPY = Define::kWindowSizeY * 3 / 8;
//	const int BOTTOMY = Define::kWindowSizeY * 5 / 8;
//	const int HALFX = Define::kWindowSizeX / 2;
//
...
//		DrawBox(Define::kWindowSizeX - HALFX * m_counter / (m_ANIME_END_TIMES[0] / 6), TOPY, Define::kWindowSizeX, BOTTOMY, BOX_COLOR, TRUE);
//	}
//	else if (m_counter > m_ANIME_END_TIMES[0] * 5 / 6) 
//	{
//		DrawBox(0,TOPY, HALFX * (m_ANIME_END_TIMES[0] - m_counter) / (m_ANIME_END_TIMES[0] / 6), Define::kWindowSizeY * 5 / 8, GetColor(0x77, 0x77, 0x77), TRUE);
//		DrawBox(Define::kWindowSizeX - HALFX * (m_ANIME_END_TIMES[0] - m_counter) / (m_ANIME_END_TIMES[0] / 6), TOPY, Define::kWindowSizeX, Define::kWindowSizeY * 5 / 8, GetColor(0x77, 0x77, 0x77), TRUE);
//	}
//	else 
//	{
//		DrawBox(0, Define::kWindowSizeY * 3 / 8, Define::kWindowSizeX, Define::kWindowSizeY * 5 / 8, GetColor(0x77, 0x77, 0x77), TRUE);
//
//		//時間に応じて文字を薄くする
...
//
//		//表示する
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle("!!!勝負開始!!!", 15, m_font_32) / 2, Define::kWindowSizeY * 27 / 64, GetColor(0, 0, 0), m_font_32, "!!!勝負開始!!!");
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle("あなたは先手です", 17, m_font_32) / 2, Define::kWindowSizeY * 33 / 64, GetColor(0, 0, 0), m_font_32, "あなたは先手です");
...
//		//表示する
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle("!!!勝負開始!!!", 15, m_font_32) / 2, Define::kWindowSizeY * 27 / 64, GetColor(0, 0, 0), m_font_32, "!!!勝負開始!!!");
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle("あなたは後手です", 17, m_font_32) / 2, Define::kWindowSizeY * 33 / 64, GetColor(0, 0, 0), m_font_32, "あなたは後手です");
//		SetDrawBlendMode(DX_BLENDGRAPHTYPE_NORMAL, 0);
//	}
//
//	if (m_counter == 1) { PlaySoundMem(m_sound_start, DX_PLAYTYPE_BACK); }
...
//
//		//表示する
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle("あなたの勝ちです", 17, m_font_32) / 2, Define::kWindowSizeY * 30 / 64, GetColor(0, 0, 0), m_font_32, "あなたの勝ちです");
//		SetDrawBlendMode(DX_BLENDGRAPHTYPE_NORMAL, 0);
//	}
//}
//
...
//{
//	//両となり
//	DrawBox(0, 0, (Define::kWindowSizeX * 9 / 32) * m_counter / m_ANIME_END_TIMES[4], Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//	DrawBox(Define::kWindowSizeX, 0, Define::kWindowSizeX - (Define::kWindowSizeX * 9 / 32) * m_counter / m_ANIME_END_TIMES[4], Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//
//	const int BOX_X = Define::kWindowSizeX * 13 / 16;
//	const int BOX_Y = Define::kWindowSizeY * 14 / 16;
//	const int BOX_COLOR = GetColor(0x67, 0x67, 0x67);
//	const int CENTER_X = Define::kWindowSizeX / 2;
//	const int CENTER_Y = Define::kWindowSizeY / 2;
//
//	//最初の時間で広がる四角のアニメーション
...
//		{
//			int pos = (int)(2.0 * Define::kWindowSizeY * pow(((double)m_counter - TIME_START_ATTACK) / TIME_ATTCK, 2));
//			if (m_old.turn == true && m_old.player1.first < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 12 / 16 - pos, 1.0, 0.0, m_gr_hand[m_old.player1.first], TRUE, TRUE, FALSE);
//			}
//			else if (m_old.turn == false && m_old.player2.first < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 4 / 16 + pos, 1.0, 0.0, m_gr_hand[m_old.player2.first], TRUE, TRUE, TRUE);
//			}
//		}
//		else if (m_hand_cmd == COMMAND_1_TO_2) //１～２
//		{
//			int posy = (int)(2.0 * Define::kWindowSizeY * pow(((double)m_counter - TIME_START_ATTACK) / TIME_ATTCK, 2));
//			int posx = (int)(2.0 * Define::kWindowSizeY * pow(((double)m_counter - TIME_START_ATTACK) / TIME_ATTCK, 2) * 1.55);
//			if (m_old.turn == true && m_old.player1.first < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + posx, Define::kWindowSizeY * 12 / 16 - posy, 1.0, atan2(1.55, 1), m_gr_hand[m_old.player1.first], TRUE, TRUE, FALSE);
//			}
//			else if (m_old.turn == false && m_old.player2.first < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + posx, Define::kWindowSizeY * 4 / 16 + posy, 1.0, atan2(-1.55, 1), m_gr_hand[m_old.player2.first], TRUE, TRUE, TRUE);
//			}
//		}
...
//				DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - posx, Define::kWindowSizeY * 12 / 16 - posy, 1.0, atan2(1.55, -1), m_gr_hand[m_old.player1.second], TRUE, FALSE, TRUE);
//			}
//			else if (m_old.turn == false && m_old.player2.second < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - posx, Define::kWindowSizeY * 4 / 16 + posy, 1.0, atan2(-1.55, -1), m_gr_hand[m_old.player2.second], TRUE, FALSE, FALSE);
//			}
//		}
...
//			int pos = (int)(2.0 * Define::kWindowSizeY * pow(((double)m_counter - TIME_START_ATTACK) / TIME_ATTCK, 2));
//			if (m_old.turn == true && m_old.player1.second < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 12 / 16 - pos, 1.0, 0.0, m_gr_hand[m_old.player1.second], TRUE, FALSE, FALSE);
//			}
//			else if (m_old.turn == false && m_old.player2.second < 6) {
//				DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 4 / 16 + pos, 1.0, 0.0, m_gr_hand[m_old.player2.second], TRUE, FALSE, TRUE);
//			}
//		}
//
//		SetDrawBlendMode(DX_BLENDGRAPHTYPE_NORMAL, 0);
...
//
//		//位置移動
//		int posx = (int)(2.0 * Define::kWindowSizeY * pow(((double)m_counter - TIME_START_ATTACK) / TIME_ATTACK, 2) * 1.55);
//		if (m_hand_cmd == COMMAND_2_SELF) { posx = -1 * posx; }
//
//		//攻撃モーション
//		if (m_hand_cmd == COMMAND_1_SELF && m_old.turn == true && m_old.player1.first < 6) {
//			DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + posx, Define::kWindowSizeY * 12 / 16, 1.0, Define::PI / 2, m_gr_hand[m_old.player1.first], TRUE, TRUE, FALSE);
//		}
//		else if (m_hand_cmd == COMMAND_2_SELF && m_old.turn == true && m_old.player1.second < 6) {
//			DrawRotaGraph(Define::kWindowSizeX * 45 / 64 + posx, Define::kWindowSizeY * 12 / 16, 1.0, -Define::PI / 2, m_gr_hand[m_old.player1.second], TRUE, FALSE, FALSE);
//		}
//		else if (m_hand_cmd == COMMAND_1_SELF && m_old.turn == false && m_old.player2.first < 6) {
//			DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + posx, Define::kWindowSizeY * 4 / 16, 1.0, -Define::PI / 2, m_gr_hand[m_old.player2.first], TRUE, TRUE, TRUE);
//		}
//		else if (m_hand_cmd == COMMAND_2_SELF && m_old.turn == false && m_old.player2.second < 6) {
//			DrawRotaGraph(Define::kWindowSizeX * 45 / 64 + posx, Define::kWindowSizeY * 4 / 16, 1.0, Define::PI / 2, m_gr_hand[m_old.player2.second], TRUE, FALSE, TRUE);
//		}
//
//		SetDrawBlendMode(DX_BLENDGRAPHTYPE_NORMAL, 0);
//	}
...
//		int pos = (int)(Define::kWindowSizeX * 13.0 / 64.0 * pow((double)m_counter / ((double)m_ANIME_END_TIMES[7] * 2.0 / 5.0), 2.0));
//		int pos1 = (m_old.turn == true) ? pos : 0;
//		int pos2 = (m_old.turn == false) ? pos : 0;
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.first < 6 ? m_old.player1.first : 0], TRUE, TRUE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.second < 6 ? m_old.player1.second : 0], TRUE, FALSE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.first < 6 ? m_old.player2.first : 0], TRUE, TRUE, TRUE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.second < 6 ? m_old.player2.second : 0], TRUE, FALSE, TRUE);
//	}
//	else if (m_counter < m_ANIME_END_TIMES[7] * 4 / 5) {
//		int pos = (int)(-Define::kWindowSizeX * 13.0 / 64.0 + (int)(Define::kWindowSizeX * 13.0 / 64.0 * pow(((double)m_counter - ((double)m_ANIME_END_TIMES[7] * 2.0 / 5.0)) / ((double)m_ANIME_END_TIMES[7] * 2.0 / 5.0), 2)));
//		int pos1 = (m_old.turn == true) ? pos : 0;
//		int pos2 = (m_old.turn == false) ? pos : 0;
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 - pos1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.first < 6 ? m_new.player1.first : 0], TRUE, TRUE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 + pos1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.second < 6 ? m_new.player1.second : 0], TRUE, FALSE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 - pos2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.first < 6 ? m_new.player2.first : 0], TRUE, TRUE, TRUE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 + pos2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.second < 6 ? m_new.player2.second : 0], TRUE, FALSE, TRUE);
//	}
//	else {
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.first < 6 ? m_new.player1.first : 0], TRUE, TRUE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.second < 6 ? m_new.player1.second : 0], TRUE, FALSE, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.first < 6 ? m_new.player2.first : 0], TRUE, TRUE, TRUE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.second < 6 ? m_new.player2.second : 0], TRUE, FALSE, TRUE);
//	}
//
//	//文字の表示
//	std::string str = (m_old.turn == true) ? "あなたの采配" : "敵の采配";
//	DrawFormatStringToHandle((Define::kWindowSizeX - GetDrawStringWidthToHandle(str.c_str(), (int)str.size(), m_font_32)) / 2, Define::kWindowSizeY * 31 / 64, GetColor(0, 0, 0), m_font_32, str.c_str());
//
...
//	int posy = (m_old.turn == true) ? Define::kWindowSizeY * 55 / 64 : Define::kWindowSizeY * 5 / 64;
//	DrawFormatStringToHandle((Define::kWindowSizeX - GetDrawStringWidthToHandle(str.c_str(), (int)str.size(), m_font_32)) / 2, posy, GetColor(0, 0, 0), m_font_32, str.c_str());
//
//	//音を鳴らす
...
//{
//	//両となり
//	DrawBox(0, 0, (Define::kWindowSizeX * 9 / 32) * (m_ANIME_END_TIMES[8] - m_counter) / m_ANIME_END_TIMES[8], Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//	DrawBox(Define::kWindowSizeX, 0, Define::kWindowSizeX - (Define::kWindowSizeX * 9 / 32) * (m_ANIME_END_TIMES[8] - m_counter) / m_ANIME_END_TIMES[8], Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//
//	const int BOX_X = Define::kWindowSizeX * 13 / 16;
//	const int BOX_Y = Define::kWindowSizeY * 14 / 16;
//	const int BOX_COLOR = GetColor(0x67, 0x67, 0x67);
...
//{
//	DrawBox(Define::kWindowSizeX * 9 / 32, 0, 0, Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//	DrawBox(Define::kWindowSizeX * 23 / 32, 0, Define::kWindowSizeX, Define::kWindowSizeY, GetColor(0xa3, 0xa3, 0xa3), TRUE);
//
//	const int BOX_X = Define::kWindowSizeX * 13 / 16;
//	const int BOX_Y = Define::kWindowSizeY * 14 / 16;
//	const int BOX_COLOR = GetColor(0x67, 0x67, 0x67);
...
//{
//	DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.first < 6 ? m_old.player1.first : 0], TRUE, TRUE, FALSE);
//	DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[m_old.player1.second < 6 ? m_old.player1.second : 0], TRUE, FALSE, FALSE);
//	DrawRotaGraph(Define::kWindowSizeX * 19 / 64, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.first < 6 ? m_old.player2.first : 0], TRUE, TRUE, TRUE);
//	DrawRotaGraph(Define::kWindowSizeX * 45 / 64, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[m_old.player2.second < 6 ? m_old.player2.second : 0], TRUE, FALSE, TRUE);
//}
//
...
//			posx = Define::kWindowSizeX * 26 / 64 * (m_counter - _start_cnt) / (_end_cnt - _start_cnt);
//			if (_end_cnt < m_counter) { posx = Define::kWindowSizeX * 26 / 64; }
//		}
//
...
//
//		//手の描画
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos_pl1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[res_my1], TRUE, !turn_pl1, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos_pl1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[res_my2], TRUE, turn_pl1, FALSE);
//		DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos_pl2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[res_ene1], TRUE, !turn_pl2, TRUE);
//		DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos_pl2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[res_ene2], TRUE, turn_pl2, TRUE);
//	}
//	else {
//		const int HALFX = Define::kWindowSizeX / 2;
//		std::string str = "コマンドが違います-" + std::to_string(m_hand_cmd);
//		DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle(str.c_str(), (int)str.size(), m_font_32) / 2, Define::kWindowSizeY * 20 / 64, GetColor(0, 0, 0), m_font_32, str.c_str());
//	}
//}
//
...
//
//	//手の描画
//	DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos_pl1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[res_my1 < 6 ? res_my1 : 0], TRUE, !turn_pl1, FALSE);
//	DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos_pl1, Define::kWindowSizeY * 12 / 16, 1.0, 0.0, m_gr_hand[res_my2 < 6 ? res_my2 : 0], TRUE, turn_pl1, FALSE);
//	DrawRotaGraph(Define::kWindowSizeX * 19 / 64 + pos_pl2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[res_ene1 < 6 ? res_ene1 : 0], TRUE, !turn_pl2, TRUE);
//	DrawRotaGraph(Define::kWindowSizeX * 45 / 64 - pos_pl2, Define::kWindowSizeY * 4 / 16, 1.0, 0.0, m_gr_hand[res_ene2 < 6 ? res_ene2 : 0], TRUE, turn_pl2, TRUE);
//}
//
...
//		posx = Define::kWindowSizeX * 18 / 64 - (GetDrawStringWidthToHandle("0 + 0 → 0", 11, m_font_32)) / 2;
//	}
//	else {
//		posx = Define::kWindowSizeX * 46 / 64 - (GetDrawStringWidthToHandle("0 + 0 → 0", 11, m_font_32)) / 2;
//	}
//
//	//y座標の算出
//	if (m_old.turn == true) {
//		posy = Define::kWindowSizeY * 5 / 64;
//	}
//	else {
//		posy = Define::kWindowSizeY * 55 / 64;
//	}
//
//	//計算式
...
//	DrawFormatStringToHandle(HALFX - GetDrawStringWidthToHandle(str.c_str(), (int)str.size(), m_font_32) / 2, Define::kWindowSizeY * 31 / 64, GetColor(0, 0, 0), m_font_32, str.c_str());
//}
//
