...
class DxLibInput final {
 public:
  ...
  inline int getCursorPosX() const { return mouse_.GetCursorPosX(); }

  inline int getCursorPosY() const { return mouse_.getCursorPosY(); }

  inline int getDiffPosX() const { return mouse_.getDiffPosX(); }

  inline int getDiffPosY() const { return mouse_.getDiffPosY(); }

  inline double getDiffPos() const { return mouse_.getDiffPos(); }

  inline int getMouseWheelRot() const { return mouse_.getWheelRot(); }

  inline bool isAnyMousePressed() const { return mouse_.isAnyButtonPressed(); }
