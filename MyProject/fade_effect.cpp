...
FadeEffect::FadeEffect(int fade_time, FadeType fade_type,
                       std::function<void()> callback)
    : fade_time_(fade_time), fade_type_(fade_type), callback_(callback) {}
...
void FadeEffect::draw() const {
  ...
  DxLib::DrawBox(0, 0, GameConst::kResolutionX, GameConst::kResolutionY,
