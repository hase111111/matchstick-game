...
void RuleBackGroundBase::draw() const {
  ...
  DrawBox((GameConst::kResolutionX + x_dif - box_size_x) / 2,
          (GameConst::kResolutionY + y_dif - box_size_y) / 2,
          (GameConst::kResolutionX + x_dif + box_size_x) / 2,
          (GameConst::kResolutionY + y_dif + box_size_y) / 2, color_back, TRUE);
