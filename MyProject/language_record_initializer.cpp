...
LanguageRecord LanguageRecordInitializer::initialize(
  ...
  for (const auto& country_enum :
       magic_enum::enum_values<LanguageRecord::Country>()) {
...
std::string LanguageRecordInitializer::getLanguageFilePath(
    LanguageRecord::Country country) const {
  switch (country) {
