...
void MenuScene::initUI(
    ...
    const auto to_game_button_ptr = std::make_shared<MenuButton>(
        ...
        [this, scene_change_callback]() { scene_change_callback(SceneName::kGame); },
        true);
    ...
    const auto to_rule_button_ptr = std::make_shared<MenuButton>(
        ...
        [this, scene_change_callback]() { scene_change_callback(SceneName::kRule); });
    ...
    const auto to_setting_button_ptr = std::make_shared<MenuButton>(
        ...
        [this, scene_change_callback]() { scene_change_callback(SceneName::kSetting); });
    ...
    const auto to_replay_button_ptr = std::make_shared<MenuButton>(
        ...
        [this, scene_change_callback]() { scene_change_callback(SceneName::kReplay); });
    ...
    const auto to_language_button_ptr = std::make_shared<MenuButton>(
        ...
        [this, scene_change_callback]() { scene_change_callback(SceneName::kLanguage); });
